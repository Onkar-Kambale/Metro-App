...
import java.io.*;
 ...
 /////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public static void Create_Metro_Map(Graph_M g)
  {
   ...
   g.addVertex("Dapodi");
   g.addVertex("Deccan Gymkkhana");
   g.addVertex("Garware College");
   g.addVertex("Ideal Colony");
   g.addVertex("Kalyani Nagar");
   g.addVertex("Kasba Peth");
   g.addVertex("Kasarwadi");
   g.addVertex("Mangalwar Peth");
   g.addVertex("Mandai");
   g.addVertex("PMC Bhavan");
   g.addVertex("Nal Stop");
   g.addVertex("Pune Railway Station");
   g.addVertex("Ruby Hall Clinic");
   g.addVertex("Shivaji Nagar");
   g.addVertex("Vanaz");
   
   g.addEdge("Vanaz", "Shivaji Nagar", 8);
   g.addEdge("Shivaji Nagar", "Ruby Hall Clinic", 10);
   g.addEdge("Ruby Hall Clinic", "Pune Railway Station", 8);
   g.addEdge("Pune Railway Station", "Mandai", 6);
   g.addEdge("Mandai", "Nal Stop", 9);
   g.addEdge("Kasarwadi", "Kasba Peth", 7);
   g.addEdge("Nal Stop", "Kasarwadi", 6);
   g.addEdge("Kasba Peth", "Kalyani Nagar", 15);
   g.addEdge("Kalyani Nagar", "Ideal Colony", 6);
   g.addEdge("Ideal Colony", "Garware College", 7);
   g.addEdge("Garware College", "Deccan Gymkkhana", 1);
   g.addEdge("Deccan Gymkkhana", "Dapodi", 2);
   g.addEdge("Dapodi", "Civil Court", 5);
   g.addEdge("Civil Court", "Chhatrapati Sambhaji Udyan", 2);
   g.addEdge("Chhatrapati Sambhaji Udyan", "Bund Garden", 7);
   g.addEdge("Bund Garden", "Bopdi", 8);
   g.addEdge("Bopdi", "Anand nagar", 2);
   g.addEdge("Anand nagar", "Vanaz", 2);
   g.addEdge("Vanaz", "Anand nagar", 3);
  }
